...
template['source']="Perform Link Prediction for the node: Node represents academic paper with a specific topic. node {} is featured with its abstract: {}. Which node will be connected to {} within one hop?"
template['target'] = "{}"
template['task'] = "link"
template['source_argc'] = 7
template['source_argv'] = ['node_id', 'node_id_list','node_id_tuple_list','node_id','node_id_tuple']
...
template['source']="Classify the article according to its topic into one of the following categories:[theory, reinforcement learning, genetic algorithms, neural networks, probabilistic methods, case based, rule learning]. Node represents academic paper with a specific topic. node {} is featured with its abstract: {}. Which category should {} be classified as?"
template['target'] = "{}"
template['task'] = "classification"
template['source_argc'] = 3
template['source_argv'] = ['node_id', 'abs','node_id']
