...
def parse_args(parse=True, **optional_kwargs):
    ...
    # Model Config
    parser.add_argument('--backbone', type=str, default='google/flan-t5-large')
    parser.add_argument('--tokenizer', type=str, default='T5TokenizerFast')
    #parser.add_argument('--whole_word_embed', action='store_true')  #Abandoned. Nothing related to our paper.
