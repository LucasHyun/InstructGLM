            ...
            if task_template['id'] == '5-5-5-5': 
                ...
                if self.mode!=None: 
                    ...
                    while go_on and count < len(self.train_L1[point]):  
                        ...
                        # select: [0, 1]
                        # idx: 0
                        # node_list: <extra_id_0>, 
                        # source_text: Classify the article according to its topic into one of the following
                        # categories: [ experimental, second, first ]. Node represents academic paper with a
                        # specific topic, link represents a citation between the two papers. Pay attention to
                        # the multi-hop link relationship between the nodes. <extra_id_0> is connected with <extra_id_0>
                        # within one hop. Which category should <extra_id_0> be classified as?
